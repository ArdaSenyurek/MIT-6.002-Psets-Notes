...
class WeightedEdge(Edge):
    def __init__(self, src, dest, total_distance, outdoor_distance):
        self.src = src
        self.dest = dest
        self.Tdistance = int(total_distance)
        self.Odistance = int(outdoor_distance)

    def get_total_distance(self):
        return self.Tdistance

    def get_outdoor_distance(self):
        return self.Odistance

    def __str__(self):
        return f'{self.src}->{self.dest} ({str(self.Tdistance)}, {str(self.Odistance)})'
...
class Digraph(object):
    ...
    def add_edge(self, edge):
        ...
        if src not in self.nodes or not dest in self.nodes:
